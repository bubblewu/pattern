package com.bubble.pattern.behavioral.observer.pc;
...
public class PCMainV2 {
    ...
    public static void main(String[] args) {
        ...
        //            Object[] buffer1 = new Object[3];
        //            Object[] buffer2= new Object[3];
        //            MakerExchangerThread makerThread = new MakerExchangerThread("-> Maker." + i, exchanger,
        //            buffer1, 2020 + i);
        //            makerThread.start();
        //            EaterExchangerThread eaterThread = new EaterExchangerThread("Eater." + i, exchanger, buffer2,
        //            2020 + i);
        //            eaterThread.start();
        //        }
    }
